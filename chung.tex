...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[RE,RO]{J S\&E \textbf{2}, 43--48 (2026)}
...
\fancyhf{}
\fancyhead[C]{Journal of Science \& Engineering \textbf{2}, 43--48 (2026)}
\fancyfoot[C]{\thepage}
}
...
\begin{table}
\caption{Three-trial mean position-time relationship of each object ($n=3$)}
\label{tab:trackery}
\end{table}

\begin{table}
\caption{Three-trial mean velocity-time relationship of each object ($n=3$)}
\label{tab:trackerv}
\end{table}
